  ...
  return (
    ...
    <div className="a">
      ...
      <div className="a-right">
        ...
        <p className="a-sub">
        I'm Tim. I'm a Web Developer/Designer/Digital Marketing Content Creator with a passion for photography/drone photography. 📸
        </p>
        <p className="a-desc">
        ...
        <div className="a-callout lg">
          ...
          <div className="a-callout-texts">
            ...
            Please feel free to take a look at the work I do for my company <a href="https://www.cupocode.com" target="_blank" rel="noreferrer">Cup O Code</a>, see some of my work in my <a href="#portfolio">Portfolio</a> below and check out my <a href="https://www.timkeeley.com/resume" target="_blank" rel="noreferrer">Résumé</a>.
            </p>
          </div>
        </div>
      </div>
